...
namespace DatingApp.DataAccess.Migrations
{
    ...
    [Migration("20240910174813_message")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingApp.Domain.Aggregates.UserProfileAggregates.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatingApp.Domain.Aggregates.UserProfileAggregates.UserLike", b =>
                {
            ...
            modelBuilder.Entity("DatingApp.Domain.Aggregates.UserProfileAggregates.Message", b =>
                {
                    b.HasOne("DatingApp.Domain.Aggregates.UserProfileAggregates.UserProfile", "Recipient")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DatingApp.Domain.Aggregates.UserProfileAggregates.UserProfile", "Sender")
            ...
            modelBuilder.Entity("DatingApp.Domain.Aggregates.UserProfileAggregates.UserLike", b =>
                {
                    b.HasOne("DatingApp.Domain.Aggregates.UserProfileAggregates.UserProfile", "SourceUser")
                        .WithMany("LikedUsers")
                        .HasForeignKey("SourceUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DatingApp.Domain.Aggregates.UserProfileAggregates.UserProfile", "TargetUser")
